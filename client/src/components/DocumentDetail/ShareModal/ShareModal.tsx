...
import { setEmailInput, setMatchedUser,setCollaborator,setModified,setUserAddedList } from "../../../store/shareModalSlice";
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="w-[620px] min-h-[398px] rounded-2xl flex justify-between flex-col bg-white shadow-xl p-8 relative">
        ...
        <ShareModalFooter document={document} action={action} refetchDocument={refetchDocument}/>
      </div>
    </div>
  );
}
