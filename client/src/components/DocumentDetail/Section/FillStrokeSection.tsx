...
export default function FillStrokeSection({style,setFillColor,fillColor,stroke,setStroke}:FillStrokeSectionProps) {
  const colors = ["transparent","black","red","blue","teal","yellow","light-blue","white",];
  return (
    <div className="mb-4">
      {style === "fill" ? (
